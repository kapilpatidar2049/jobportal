...
!function () {
    ...
    /**
         ...
         */
    function Ly(e) { return function (t) { for (var n = arguments.length, o = new Array(n > 1 ? n - 1 : 0), r = 1; r < n; r++)o[r - 1] = arguments[r]; return Cy(e, t, o) } } function My(e, t) {
        let n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : ky; fy &&
            // Make 'in' and truthy checks like Boolean(set.constructor)
            // independent of any properties defined on Object.prototype.
            // Prevent prototype setters from intercepting set as a this value.
            fy(e, null); let o = t.length; for (; o--;) {
                let r = t[o]; if ("string" == typeof r) {
                    const e = n(r); e !== r && (
...
/**
    ...
    const lC = function () { return "undefined" == typeof window ? null : window }; var dC = function e() {
        let t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : lC(); const n = t => e(t)
/**
...
/* Parsing of strict XHTML documents */let we = null; const Ee = ["application/xhtml+xml", "text/html"]; let xe = null, _e = null;
        ...
        const ke = o.createElement("form"), Se = function (e) { return e instanceof RegExp || e instanceof Function }, Ne = function () {
            let e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}; if (!_e || _e !== e) {
                if (
...
/* Add tbody to ALLOWED_TAGS in case tables are permitted, see #286, #365 */, F.table && (My(F, ["tbody"]), delete $.tbody), e.TRUSTED_TYPES_POLICY) {
                    if ("function" != typeof e.TRUSTED_TYPES_POLICY.createHTML) throw Py('TRUSTED_TYPES_POLICY configuration option must provide a "createHTML" hook.'); if ("function" != typeof e.TRUSTED_TYPES_POLICY.createScriptURL) throw Py('TRUSTED_TYPES_POLICY configuration option must provide a "createScriptURL" hook.');
        ...
        }, Re = My({}, ["mi", "mo", "mn", "ms", "mtext"]), Ae = My({}, ["annotation-xml"]), Te = My({}, ["title", "style", "font", "a", "script"]), Oe = My({}, [...jy, ...Hy, ...$y]), Be = My({}, [...Vy, ...qy]), Pe = function (e) {
            _y(n.removed, { element: e }); try {
                // eslint-disable-next-line unicorn/prefer-dom-node-remove
                C(e).removeChild(e)
            } catch (t) { b(e) }
        }, De = function (e, t) {
            try { _y(n.removed, { attribute: t.getAttributeNode(e), from: t }) } catch (e) { _y(n.removed, { attribute: null, from: t }) }
            // We void attribute values for unremovable "is"" attributes
            if (t.removeAttribute(e), "is" === e && !z[e]) if (ee || te) try { Pe(t) } catch (e) { } else try { t.setAttribute(e, "") } catch (e) { }
        }, Le = function (e) {
            /* Create a HTML document */
            let t = null, n = null; if (J) e = "<remove></remove>" + e; else {
                /* If FORCE_BODY isn't used, leading whitespace needs to be preserved manually */
                const t = Ny(e, /^[\r\n\t ]+/); n = t && t[0]
            } "application/xhtml+xml" === we && be === he && (
...
/* Use createHTMLDocument in case DOMParser is not available */if (!t || !t.documentElement) {
                t = x.createDocument(be, "template", null); try { t.documentElement.innerHTML = ve ? E : r } catch (e) {
                    // Syntax error if dirtyPayload is invalid xml
                }
            } const s = t.body || t.documentElement;
            /* Work on whole document or just its body */
            return e && n && s.insertBefore(o.createTextNode(n), s.childNodes[0] || null), be === he ? S.call(t, Z ? "html" : "body")[0] : Z ? t.documentElement : s
        }, Me = function (e) {
            return _.call(e.ownerDocument || e, e,
...
/* Check whether element has a valid namespace */return e instanceof d && !function (e) {
                let t = C(e);
                ...
                t && t.tagName || (t = { namespaceURI: be, tagName: "template" }); const n = ky(e.tagName), o = ky(t.tagName); return !!ye[e.namespaceURI] && (e.namespaceURI === pe ?
                    ...
                    t.namespaceURI === he ? "svg" === n :
                        ...
                        t.namespaceURI === he ? "math" === n :
                            ...
                            !(t.namespaceURI === pe && !Ae[o]) && !(t.namespaceURI === ge && !Re[o]) && !Be[n] && (Te[n] || !Oe[n]) : !("application/xhtml+xml" !== we || !ye[e.namespaceURI]))
            }(e) ? (Pe(e), !0) :
...
/* Execute a hook if present */, Ue("afterSanitizeElements", e, null), !1) : (Pe(e), !0)
        }, je = function (e, t, n) {
...
/* Allow valid data-* attributes: At least one character after "-"
            ...
            We don't need to check the value; it's always URI safe. */if (W && !V[t] && By(B, t)); else if (q && By(P, t)); else if (!z[t] || V[t]) {
                if (
...
} else if (me[t]); else if (By(I, Ry(n, L, ""))); else if ("src" !== t && "xlink:href" !== t && "href" !== t || "script" === e || 0 !== Ay(n, "data:") || !ce[e]) if (K && !By(D, Ry(n, L, ""))); else if (n) return !1; return !0
        }, He = function (e) { return "annotation-xml" !== e && Ny(e, M) }, $e = function (e) {
            /* Execute a hook if present */
            Ue("beforeSanitizeAttributes", e, null); const { attributes: t } = e;
/* Check if we have attributes; if not we might have a text node */if (!t) return; const o = { attrName: "", attrValue: "", keepAttr: !0, allowedAttributes: z }; let r = t.length;
/* Go backwards over all attributes; safely remove bad ones */for (; r--;) {
                const s = t[r], { name: a, namespaceURI: i, value: l } = s, d = xe(a); let c = "value" === a ? l : Ty(l); const u = c;
                /* Execute a hook if present */
...
/* Handle invalid data-* attribute set by try-catching it */if (c !== u) try {
                            i ? e.setAttributeNS(i, a, c) :
                                /* Fallback to setAttribute() for browser-unrecognized namespaces e.g. "x-schema". */
                                e.setAttribute(a, c), Ie(e) ? Pe(e) : xy(n.removed)
                        } catch (e) { }
                    } else De(a, e)
            }
/* Execute a hook if present */Ue("afterSanitizeAttributes", e, null)
        }, Ve = function e(t) {
            let n = null; const o = Me(t);
...
/* Execute a hook if present */Ue("afterSanitizeShadowDOM", t, null)
        ...
        return n.sanitize = function (e) {
            let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, o = null, s = null, i = null, d = null;
...
/* Clean up removed elements */, n.removed = [],
                ...
                if (e.nodeName) { const t = xe(e.nodeName); if (!F[t] || $[t]) throw Py("root node is forbidden and cannot be sanitized in-place") }
...
/* Return sanitized string or DOM */if (ee) {
                if (te) for (d = k.call(o.ownerDocument); o.firstChild;)
                    // eslint-disable-next-line unicorn/prefer-dom-node-append
