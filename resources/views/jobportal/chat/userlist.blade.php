                        ...
                        <div id="chat-app">
                            <ul class="list-group">
                                ...
                                <div v-for="user in users" :key="user.id" class="message">
                                    <a :href="`/jobportal/chat/${user.id}`" :title="user.email">
                                        <li>
                                            <div class="row align-center" :class="{ 'highlight': user.seen == 0 && user.receiver_id == user.auth_id }">
...
<style scoped>
    .highlight {
        background-color: #f0f8ff; /* Highlight color for unseen messages */
    }
    .sendermsg {
        font-weight: bold; /* Optional: make it bold for sent messages */
    }
</style>
