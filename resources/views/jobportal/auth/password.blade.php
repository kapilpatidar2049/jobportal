    ...
    <body>
        ...
        <div class="main">
            ...
            <div class="loginform">
                ...
                <form action="{{ route('jobportal.dologin') }}" method="post">
                    @csrf

                    <div class="form-group">
                        <label for="email" class="form-label">{{ __('Email') }}</label>
                        <input type="email" readonly class="form-control" id="email" name="email"
                            value="{{ old('email', $email) }}" placeholder="{{ __('Enter Your Email') }}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="password">
                            ...
                            <div class="eye"><i class="fa-solid fa-eye-slash"
                                    onclick="passwordToggle('password', this)"></i></div>
                        </div>
        ...
        <script>
            function passwordToggle(elementId, button) {
